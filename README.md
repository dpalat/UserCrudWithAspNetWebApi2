...
<p align="center">
  <img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/logo_transparent.png" width="460px" />
</p>
...
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/multiplestart.png" width="600px" />
...
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/Admin_detail_0.gif" width="600px" />

> Admin user has only ADMIN role and with this Role can access to all pages: Page 1, Page 2, Page 3 and User Directory.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/Admin_detail_1.gif" width="600px" />
...
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/Admin_detail_2.gif" width="600px" />


## User with common role view

> User 1@user.com (1234) can only access to Page 1. The other pages show a Forbidden message.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/User_detail.gif" width="600px" />


## User with common role view

> The api User only allows a User with ADMIN Role.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/api_admin.gif" width="600px" />

> The api implents a content negotiation in the User [GET] and you can ask for XML response.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/api_xml.gif" width="600px" />

> The api implents a content negotiation in the User [GET] and you can ask for Json response.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/api_json.gif" width="600px" />

> The api implents a content negotiation in the User [GET] and can you use Quality Factor.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/api_quality_factor.gif" width="600px" />


## Coverage

> Now there is 100% Coverage in the layer which aren't WebApi or WebUI.
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/Coverage.png" width="600px" />
...
<img src="https://github.com/dpalat/UserCrudWithAspNetWebApi2/blob/master/Documentation/CoverageBat.png" width="400px" />
